...
export class Blog extends React.Component {
    ...
    componentDidMount() {
        return fetch('https://public-api.wordpress.com/rest/v1.1/sites/apptestbackend.wordpress.com/posts')
                        ...
                        <FlatList 
                            ...
                            renderItem={({item}) =>
                                <BlogItem
                                    id={item.ID}
                                    title={item.title}
                                    imageSrc={item.featured_image || 'http://www.wiuu.edu.ua/wp-content/uploads/2015/01/Picture_online-2015.jpg'}
